		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "zcaseprdfs11",
									"targetURL": "#comibmzcaseprdfs11-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibmzcaseprdfs11-display": {
								"semanticObject": "comibmzcaseprdfs11",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibm.zcaseprdfs11",
									"url": sap.ui.require.toUrl("com/ibm/zcaseprdfs11")
								}
							}
						}
					}
